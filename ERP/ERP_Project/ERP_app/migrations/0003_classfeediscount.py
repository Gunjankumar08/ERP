...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ERP_app', '0002_alter_reception_created'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admission', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='classFeeDiscount', to='ERP_app.admissions_form')),
            ],
        ),
    ]
